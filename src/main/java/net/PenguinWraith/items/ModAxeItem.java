...
public class ModAxeItem extends MiningToolItem {
    static final Map<Block, Block> STRIPPED_BLOCKS;

    ModAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
